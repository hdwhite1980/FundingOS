...
BEGIN
  ...
  ELSE
    ...
    ALTER TABLE projects ALTER COLUMN project_categories TYPE JSONB USING project_categories::JSONB;
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    ALTER TABLE projects ALTER COLUMN primary_goals TYPE JSONB USING primary_goals::JSONB;
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    ALTER TABLE projects ALTER COLUMN preferred_funding_types TYPE JSONB USING preferred_funding_types::JSONB;
  END IF;
END $$;
