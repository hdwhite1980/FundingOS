    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Footer */}
          <div className="flex items-center justify-between p-6 sm:p-8 border-t border-slate-100 bg-slate-25">
            <button
              type="button"
              onClick={() => setCurrentStep(Math.max(1, currentStep - 1))}
              disabled={currentStep === 1}
              className="px-6 py-2.5 bg-white text-slate-700 font-medium rounded-lg border border-slate-300 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Previous
            </button>
            ...
            <div className="flex space-x-3">
              {currentStep < 3 ? (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2.5 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 disabled:opacity-50 flex items-center transition-colors"
                >
                  {loading ? (
                    <>
