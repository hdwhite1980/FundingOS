...
export function classifyAssistantIntent(message) {
  ...
  // Campaign patterns
  if (lower.match(/\b(campaign|campaigns|crowdfunding|fundraising|fundraiser|kickstarter|gofundme|indiegogo)\b/)) {
    return 'campaign_lookup'
  }
  
  // Project patterns
  if (lower.match(/\b(project|projects|my\s*project|project\s*info|project\s*details|project\s*status)\b/)) {
