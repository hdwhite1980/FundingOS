...
class AIProviderService {
  constructor() {
    ...
    this.providerStrategy = {
      ...
      // Enhanced scoring - use GPT-4o for better strategic analysis
      'enhanced-scoring': {
        provider: 'openai',
        model: 'gpt-4o',
        reason: 'Superior analytical reasoning and strategic assessment capabilities'
      },
      
      // Basic scoring - use GPT-4o for consistency
      'basic-scoring': {
        provider: 'openai',
        model: 'gpt-4o',
        reason: 'Consistent high-quality scoring across all tasks'
      },
