...
export class AIService {
  ...
  static async generateUnifiedStrategy(userContext, situationAnalysis) {
    try {
      const response = await fetch('/api/ai/agent/generate-strategy', {
        method: 'POST',
        headers: {
  ...
  static async completeForm(formFields, companyData, projectData) {
    try {
      const response = await fetch('/api/ai/smart-form-completion', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
`
  ...
  static async analyzeOpportunityMatch(opportunity, organizationProfile) {
    try {
      const response = await fetch('/api/ai/enhanced-scoring', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
