...
class UnifiedFundingAgent {
  ...
  async handleUserMessage(message, context = {}) {
    try {
      ...
      if (lowerMessage.includes('search internet') || lowerMessage.includes('web search') || lowerMessage.includes('find new') || lowerMessage.includes('discover opportunities')) {
  ...
  extractSearchQuery(message) {
    ...
    const cleanMessage = message
      .replace(/search internet for|find new|discover opportunities|web search for|look for|can you|could you|please/gi, '')
      .replace(/\s+/g, ' ')
      .trim()
